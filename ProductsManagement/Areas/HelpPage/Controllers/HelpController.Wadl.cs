...
using ProductsManagement.Areas.HelpPage.ModelDescriptions;
using ProductsManagement.Areas.HelpPage.Models;

namespace ProductsManagement.Areas.HelpPage.Controllers
{
